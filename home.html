...
<head>
    ...
    <!-- stylesheet consisting of media queries -->
    <link rel="stylesheet" type="text/css" href="responsiveHome.css">
    <!-- font awesome-->
    <script src="https://kit.fontawesome.com/8658b34f76.js" crossorigin="anonymous"></script>
</head>
...
<nav class="navigation-bar">
    ...
    <div class="title-combo">
        <div class="website-logo">
            <img src="media/website_logo.png" alt="website-logo">
        </div>
    ...
    <div class="notification-bell">
        <img src="media/bell_icon.png" alt="bell-icon">

    </div>
    <!-- this is for profile picture -->
    <div class="profile-picture">
        <img src="media/profile_picture.png" alt="profile-picture">
    </div>
</nav>
    ...
    <aside class="aside section-1">
        ...
        <div class="outer-carousel">
            <div class="carousel">
                ...
                <img src="media/crousel/carousel1.jpg" alt="carousel-image-1">
                <img src="media/crousel/carousel2.jpg" alt="carousel-image-2">
                <img src="media/crousel/carousel3.jpg" alt="carousel-image-3">
            </div>
        </div>
            ...
            <div class="latest-release-content">
                ...
                <div class="card">
                    <div>
                        ...
                        <img src="media/songs/willow.jpeg" alt="willow">
                    ...
                    <div class="options">
                        ...
                        <div class="latest-release-dropdown">
                            <div class="drop-item">
                                ...
                                <p><i class="fas fa-play-circle"></i> <a href="second.html">Play
                                    Now</a></p>
                            </div>
                            <hr>
                            <div class="drop-item">
                ...
                <div class="card">
                    <div>
                        <img src="media/songs/Weeknd.jpg" alt="weekend">
                        <div class="play-button">
                            <i class="fas fa-play" style="width:45%; height:45%; display:inline-block"></i>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <img src="media/songs/DaBaby.jpg" alt="DaBaby">
                        <div class="play-button">
                            <i class="fas fa-play" style="width:45%; height:45%; display:inline-block"></i>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <img src="media/songs/dynamite.jpg" alt="dynamite">
                        <div class="play-button">
                            <i class="fas fa-play" style="width:45%; height:45%; display:inline-block"></i>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <img src="media/songs/shit.png" alt="shit">
                        <div class="play-button">
                            <i class="fas fa-play" style="width:45%; height:45%; display:inline-block"></i>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div>
                        <img src="media/songs/falling.jpg" alt="falling">
                        <div class="play-button">
                            <i class="fas fa-play" style="width:45%; height:45%; display:inline-block"></i>
                        </div>
                    </div>
        ...
        <div class="popular-artists">
            ...
            <div class="popular-artist-content">
                ...
                <a href="second.html">
                    <div>
                        <img src="media/popular artists/ed sheeran.jpg" alt="ed sheeran">
                ...
                <a href="second.html">
                    <div>
                        <img src="media/popular artists/Coldplay-Contact-Information.jpg" alt="cold play">
                        <div><i class="fas fa-play"></i></div>
                        <p>
                            Cold Play
                        </p>
                ...
                <a href="second.html">
                    <div>
                        <img src="media/popular artists/2018_10_29_zayn_malik_portrait.jpg" alt="zayn">
                        <div><i class="fas fa-play"></i></div>
                        <p>
                            Zayn
                        </p>
                ...
                <a href="second.html">
                    <div>
                        <img src="media/popular artists/0ee3447ad98c409357e0a1b002481d0e9e-01-charlie-puth.rsquare.w700.jpg"
                             alt="charlie puth">
                        <div><i class="fas fa-play"></i></div>
                        <p>
                            Charlie Puth
                ...
                <a href="second.html">
                    <div>
                        <img src="media/popular artists/imagine-dragons-lil-wayne.jpg" alt="imagine dragons">
                        <div><i class="fas fa-play"></i></div>
                        <p>
                            Imagine Dragons
                        </p>
                ...
                <a href="second.html">
                    <div>
                        <img src="media/popular artists/bruno mars.jpg" width="15vw" height="10vw" alt="bruno mars">
                        <div><i class="fas fa-play"></i></div>
                        <p>
                            Bruno Mars
                        </p>
        ...
        <div class="music-themes">
            ...
            <div class="theme-main">
                <div class="theme-content">
                    <img src="media/music themes/chill.jpg" alt="chill">
                    <p>Vibe</p>
                </div>
                <div class="theme-content">
                    <img src="media/music themes/rock.jpg" alt="rock">
                    <p>Rock</p>
                </div>
                <div class="theme-content">
                    <img src="media/music themes/love.jpg" alt="love">
                    <p>Love</p>
                </div>
                <div class="theme-content">
                    <img src="media/music themes/pop.jpg" alt="pop">
                    <p>Pop</p>
                </div>
                <div class="theme-content">
                    <img src="media/music themes/retro.jpg" alt="retro">
                    <p>Retro</p>
                </div>
                <div class="theme-content">
                    <img src="media/music themes/workout.jpg" alt="workout">
                    <p>GYM</p>
                </div>
            </div>
        </div>
        ...
        <div class="language english">
            ...
            <div class="language-content">
                <div>
                    <img src="media/latest english/I'll Wait.jpg" alt="i'll wait">
                    <p>I'll Wait</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest english/let me go.jpg" alt="let me go">
                    <p>Let me Go!</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest english/qurantine clean.jpg" alt="qurantine">
                    <p>Qurantine Clean</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest english/roar.jpg" alt=roar>
                    <p>Roar</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest english/toosie slide.jpg" alt="toosie">
                    <p>Toosie Slide</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest english/uptown funk.png" alt="funk">
                    <p>Uptown Funk</p>
                    <p>Aug 11, 2017</p>
                </div>
            </div>
        ...
        <div class="language hindi">
            ...
            <div class="language-content">
                ...
                <div>
                    <img src="media/latest hindi/baarish.jpeg" alt="baarish">
                    <p>Baarish</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest hindi/galiyaan.jpg" alt="galiyaan">
                    <p>Galiyaan</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest hindi/giveme some sunshine.jpg" alt="sumshine">
                    <p>Give me Some Sunshine</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest hindi/kaun tujhe.jpg" alt="kaun tujhe">
                    <p>Kaun Tujhe</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest hindi/tera ban jaunga.jpg" alt="tera ban jaunga">
                    <p>Tera Ban Jaunga</p>
                    <p>Aug 11, 2017</p>
                </div>
                <div>
                    <img src="media/latest hindi/tere sang yara.jpg" alt="tere sang yara">
                    <p>Tere Sang Yaara</p>
                    <p>Aug 11, 2017</p>
                </div>
            </div>
        ...
        <div class="playlist-content">
            ...
            <div class=playlist-item>
                <div class="left-content">
                    ...
                    <div class="coverer">
                        ...
                        <img src="media/playlist/austin-neill-kKlVSrFbjYY-unsplash.jpg" alt="austin neil">
                        <div class="play-button">
            ...
            <div class=playlist-item>
                <div class="left-content">
                    ...
                    <div class="coverer">
                        <img src="media/playlist/after.jpg" alt="after">
                        <div class="play-button">
                            <i class="fas fa-play" aria-hidden="true"></i>
                        </div>
                    </div>
            ...
            <div class=playlist-item>
                <div class="left-content">
                    ...
                    <div class="coverer">
                        <img src="media/playlist/stoney.jpg" alt="stoney">
                        <div class="play-button">
                            <i class="fas fa-play" aria-hidden="true"></i>
                        </div>
                    </div>
            ...
            <div class=playlist-item>
                <div class="left-content">
                    ...
                    <div class="coverer">
                        <img src="media/playlist/beer.jpg" alt=beer>
                        <div class="play-button">
                            <i class="fas fa-play" aria-hidden="true"></i>
                        </div>
                    </div>
            ...
            <div class=playlist-item>
                <div class="left-content">
                    ...
                    <div class="coverer">
                        <img src="media/songs/sorry.jpg" alt="sorry">
                        <div class="play-button">
                            <i class="fas fa-play" aria-hidden="true"></i>
                        </div>
                    </div>
...
<footer>
    ...
    <div class="extras">
        ...
        <div class="slidecontainer" style="width:30%;">
            <input type="range" min="0" max="100" value="0" class="slider" id="myRange" style="margin-top:0;">
        </div>
        <div>
